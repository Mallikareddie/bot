...
# Your backend script
from your_backend_script import get_answer  # Update with the actual function you use
...
qa_chain = RetrievalQAWithSourcesChain.from_llm(llm=llm, retriever=kal.as_retriever())
...
def ask_question():
    if request.method == 'POST':
        ...
        answer = get_answer(qa_chain, question)  # Use your backend logic here
